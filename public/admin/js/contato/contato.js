...
$('#editar').on('show.bs.modal', function (event) {
  ...
  var email = button.data('email'); // var tipocontato     = button.data('tipocontato');
  ...
  modal.find('.modal-body #email').val(email); // modal.find('.modal-body #tipocontato').val(tipocontato);
