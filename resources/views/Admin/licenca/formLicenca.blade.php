...
<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			<label for="hash">Código de ativação</label>
			<div class="input-group">
				<input required onkeypress="return false;" type="text" class="form-control hash" id="hash" placeholder="Código de ativação" name="hash" autocomplete="off" autofocus maxlength="265">
			</div>
		</div>
	</div>
</div>