  ...
  <div class="card card-primary card-outline card-outline-tabs" style="border-top: 0px solid #007bff;">
    ...
    <div class="card-body">
      <div class="row">
        ...
        <div class="col-md-10">
          <div class="form-group">
            <label for="titulo">Descrição do agendamento*</label>
            <div class="input-group">
              <input type="text" class="form-control titulo" autocomplete="off" id="titulo" value="{{isset($tipoevento) ? $tipoevento->titulo : ''}}" placeholder="Descrição do agendamento" {{old('titulo')}} name="titulo" required autofocus minlength="3" maxlength="50">
            </div>
          </div>
        </div>
      </div>
