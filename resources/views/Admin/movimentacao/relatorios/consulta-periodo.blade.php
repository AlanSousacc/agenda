		...
		<div class="modal-content">
			...
			<form autocomplete="off" target="_blank" class="personalizado" action="{{route('relatorio.periodo.contato')}}" method="POST">
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Data Inicio</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" autocomplete="off" id="mstart" placeholder="Data/Hora Inicio" name="mstart">
						</div>
					</div>
					<div class="form-group row">
						<label class="col-sm-4 col-form-label">Data Final</label>
						<div class="col-sm-8">
							<input type="text" class="form-control" autocomplete="off" id="mend" placeholder="Data/Hora Final" name="mend">
